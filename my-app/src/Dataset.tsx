...
class Dataset extends Component<DatasetProps, DatasetState> {
	...
	render() {
		...
		return (
			<div className="p-4 bg-blue-200 rounded-full shadow-md flex items-center justify-between">
				<span className="font-bold text-blue-900">name: {id}</span>
				<span className="font-bold text-blue-900">section #: {numRows}</span>
				<button
