...
export default class FacadeSectionFunctions {
	...
	public async addRoom(id: string, sectionsDatabase: Map<string, Section[]>, content: string, kind: InsightDatasetKind): Promise<string[]> {
